<template>
  <div id="app">
    <main class="main__recipes">

      <!-- recipe of the day card (same as index) -->
      <div class="container">
        <div class="row">
        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-12 p-3">
            <article class="recipes">
              ...
              <ul>
                <li class="recipes__item" v-for="recipe in baseRecipes" v-bind:key="recipe.id">
